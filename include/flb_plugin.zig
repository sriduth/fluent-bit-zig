pub const struct_flb_plugin_proxy_def = extern struct {
    type: c_int,
    proxy: c_int,
    flags: c_int,
    name: [*c]u8,
...
pub const FLB_PROXY_OUTPUT_PLUGIN = 2;
...
pub const flb_plugin_proxy_def = struct_flb_plugin_proxy_def;
